...
const internals = {
   ...
   * @return {number}
   */
  formatDecimals: (num) => Math.round(num * 100) / 100,
...
export default class FeColorMatrixInput {
   ...
   */
  constructor(config = {}) {
    Object.assign((this.config = {}), { el: null }, config);
  }
   ...
   */
  setValue([r, g, b, a = 1]) {
    this.config.el.value = internals.getColorMatrixValue(r, g, b, a).replace(/$\s+/gm, '\n');
    return this;
  }
}
